...
class GameOver extends Phaser.Scene {
  ...
  create(score) {
    ...
    this.add.rectangle(70 + x, 180 - num, 4, 270, 0xffffff).setOrigin(0);
    this.add.rectangle(245 + x, 180 - num, 4, 270, 0xffffff).setOrigin(0);
    this.add.rectangle(230, 450 - num, 460, 4, 0xffffff);
